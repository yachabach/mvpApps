...
// import { JsonFunctions } from '@/composables/jsonFunctions.js'
...
// const { keysToObject } = JsonFunctions();
...
// console.log('Phoenix keys: ', parameterCodes)
// console.log('keysToObject: ', keysToObject(reactiveObject.program, Object.keys(parameterCodes)))
...
const handleUpdateRange = newRange => {
    ...
    reactiveObject.program.stimulation.amplitudeRange.currentLower = Number(newRange.lo)   
    reactiveObject.program.stimulation.amplitudeRange.currentUpper = Number(newRange.hi)   
}
